...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el país de un atleta por su nombre");
	...
	{
		String nombre = input("Por favor ingrese el nombre del atleta del cual desea consultar el país");
		nombre = nombre.toLowerCase();
		if (nombre != "")
		{
			String pais = calculadora.paisAtletaPorNombre(nombre);
			if (pais != "") 
			{
				System.out.println("El país del atleta " + nombre + " es " + pais.toUpperCase());
			}
			else 
			{
